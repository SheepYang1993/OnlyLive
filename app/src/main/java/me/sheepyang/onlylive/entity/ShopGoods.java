...
public class ShopGoods {
    ...
    /** called by internal mechanisms, do not call yourself. */
    @Generated(hash = 1911729678)
    public void __setDaoSession(DaoSession daoSession) {
        this.daoSession = daoSession;
        myDao = daoSession != null ? daoSession.getShopGoodsDao() : null;
    }
    /** Used for active entity operations. */
    @Generated(hash = 342049837)
    private transient ShopGoodsDao myDao;
    ...
    @Generated(hash = 1668882565)
    public ShopGoods(Long id, String name, String unit, Long numberId, Long priceId) {
        this.id = id;
        this.name = name;
        this.unit = unit;
        this.numberId = numberId;
